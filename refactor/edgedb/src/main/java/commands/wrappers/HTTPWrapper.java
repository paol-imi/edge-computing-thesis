...
public abstract class HTTPWrapper {
    ...
    protected void get() throws Exception {
        ...
        for (var entry : headers.entrySet()) {
            ...
            Logger.info("\tExtra header: " + entry.getKey() + " = " + entry.getValue());
        }
        ...
        Logger.info("(HTTPWrapper.get) Response: ");
        Logger.info("(HTTPWrapper.get) \tStatusCode: " + statusCode);
        Logger.info("(HTTPWrapper.get) \tBody: " + body);
    }
    ...
    protected void post() throws Exception {
        ...
        Logger.info("(HTTPWrapper.post) Response: ");
        Logger.info("(HTTPWrapper.post) \tStatusCode: " + statusCode);
        Logger.info("(HTTPWrapper.post) \tBody: " + body);
    }
