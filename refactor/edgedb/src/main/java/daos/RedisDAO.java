...
public abstract class RedisDAO extends StatefulDAO {
    ...
    protected RedisDAO(String table) {
        ...
        Logger.info("(RedisDAO) (Constructor) Url: " + url);
    }
    ...
    String get(String key) {
        ...
        if (key != null) {
            Logger.info("(RedisDAO.get) Redis get with key: " + key);
    ...
    void set(String key, String value) {
        ...
        if (key != null && value != null) {
            Logger.info("(RedisDAO.set) Redis set with key, value: " + key + ", " + value);
    ...
    List<String> getAllKeys() {
        ...
        Logger.info("(RedisDAO.getAllKeys) Redis keys");
    ...
    void sadd(String key, String... value) {
        ...
        if (key != null && value != null) {
            Logger.info("(RedisDAO.sadd) Redis sadd with key, value: " + key + ", " + Arrays.toString(value));
    ...
    Set<String> smembers(String key) {
        ...
        if (key != null) {
            Logger.info("(RedisDAO.smembers) Redis smembers with key: " + key);
            returnValue = syncCommands.smembers(key);
            Logger.info("(RedisDAO.smembers) Members: " + returnValue);
        }
    ...
    String getRandom() {
        ...
        Logger.info("(RedisDAO.getRandom) Redis randomkey");
        String randomKey = syncCommands.randomkey();

        String returnValue = null;
        if (randomKey != null) {
            Logger.info("(RedisDAO.getRandom) Redis get with key: " + randomKey);
    ...
    void deleteAll() {
        ...
        while (key != null) {
            Logger.info("(RedisDAO.getRandom) Redis del with key: " + key);
    ...
    protected void hset(String key, Map<String, String> map) {
        ...
        if (key != null && map != null && !map.isEmpty()) {
            Logger.info("(RedisDAO.hset) Redis hset with key, map: " + key + ", " + map);
            syncCommands.hset(key, map);
        } else {
            Logger.info("(RedisDAO.hset) Cannot execute redis hset with key, map: " + key + ", " + map);
        }
    ...
    protected String hget(String key, String field) {
        ...
        if (key != null && field != null) {
            Logger.info("(RedisDAO.hget) Redis hget with key, field: " + key + ", " + field);
    ...
    Map<String, String> hgetall(String key) {
        ...
        if (key != null) {
            Logger.info("(RedisDAO.hgetall) Redis hgetall with key: " + key);
    ...
    void del(String key) {
        ...
        if (key != null) {
            Logger.info("(RedisDAO.del) Redis del with key, value: " + key);
            syncCommands.del(key);
        }
    ...
    Long hlen(String key) {
        ...
        if (key != null) {
            Logger.info("(RedisDAO.hlen) Redis hlen with key: " + key);
    ...
    protected Boolean hexists(String key, String field) {
        ...
        if (key != null && field != null) {
            Logger.info("(RedisDAO.hexists) Redis hexists with key: " + key);
    ...
    protected Long exists(String key) {
        ...
        Long returnValue = null;
        if (key != null) {
            Logger.info("(RedisDAO.exists) Redis exists with key: " + key);
    ...
    protected Long hdel(String key, String field) {
        ...
        Long returnValue = null;
        if (key != null && field != null) {
            Logger.info("(RedisDAO.hdel) Redis hdel with key: " + key);
    ...
    boolean eval(String script, String[] accessedKey, String... scriptArgument) {
        ...
        Logger.info("(RedisDAO.eval) Redis eval:");
        Logger.info("(RedisDAO.eval) Script: " + script);
        Logger.info("(RedisDAO.eval) AccessedKeys: " + Arrays.toString(accessedKey));
        Logger.info("(RedisDAO.eval) ScriptArguments: " + Arrays.toString(scriptArgument));
    ...
    void setIfNotExists(String key, String value, long timeout) {
        ...
        args.nx();
        args.ex(timeout);
        Logger.info("(RedisDAO.setIfNotExists) Redis set: " + key + ", " + value + ", " + timeout);
