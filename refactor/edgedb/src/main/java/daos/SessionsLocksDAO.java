...
public class SessionsLocksDAO extends RedisDAO {
    ...
    public static boolean lockSession(String sessionId) {
        ...
        if (sessionId != null) {
            ...
            try {
                ...
                Logger.info("(SessionsLocksDAO.lockSession) Cannot create a random value");
            ...
            if (returnValue) {
                Logger.info("(SessionsLocksDAO.lockSession) Acquired lock on session <" + sessionId + ">");
            } else {
                Logger.info("(SessionsLocksDAO.lockSession) Was not able to acquire lock on session <" + sessionId + ">");
            }
        } else {
            Logger.info("(SessionsLocksDAO.lockSession) Session parameter equals to null");
        }
        return returnValue;
    }
    ...
    public static boolean unlockSessionAndUpdateData(String sessionId, Map<String, String> data, String requestId) {
        ...
        if (sessionId != null) {
            ...
            if (returnValue) {
                Logger.info("(SessionsLocksDAO.unlockSessionAndUpdateData) Released lock on session <" + sessionId + ">");
            } else {
                Logger.info("(SessionsLocksDAO.unlockSessionAndUpdateData) Was not able to release lock on session <" + sessionId + ">");
            }
        } else {
            Logger.info("(SessionsLocksDAO.unlockSessionAndUpdateData) Session parameter equals to null");
        }
        return returnValue;
    }
    ...
    public static boolean unlockSession(String sessionId) {
        ...
        if (sessionId != null) {
            ...
            if (returnValue) {
                Logger.info("(SessionsLocksDAO.unlockSession) Released lock on session <" + sessionId + ">");
            } else {
                Logger.info("(SessionsLocksDAO.unlockSession) Was not able to release lock on session <" + sessionId + ">");
            }
        } else {
            Logger.info("(SessionsLocksDAO.unlockSession) Session parameter equals to null");
        }
        return returnValue;
    }
