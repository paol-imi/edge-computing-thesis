...
public class SessionsDAO extends RedisDAO {
    ...
    public static SessionToken getSessionToken(String sessionId) {
        ...
        Logger.info("(SessionsDAO.getSessionToken) Trying to fetch session: " + sessionId);
        if (sessionId != null && instance.exists(sessionId) > 0) {
            ...
            Logger.info("(SessionsDAO.getSessionToken) Session fetched from local storage: " + sessionToken.getJson());
        }
        return sessionToken;
    }
    ...
    public static void setSessionToken(SessionToken sessionToken) {
        ...
        Logger.info("(SessionsDAO.setSessionToken) Session saved to local storage: " + sessionToken.getJson());
    }
    ...
    public static void updateAccessTimestampToNow(String sessionId) {
        ...
        Logger.info("(SessionsDAO.updateAccessTimestampToNow) Updated last access time of session <" + sessionId + "> to <" + now + ">");
    }
